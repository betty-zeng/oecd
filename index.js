...
const config = {
   ...
   */
  accessToken:
    'pk.eyJ1IjoiYmV0dHl6ZW5nIiwiYSI6ImNsb2ZvMjF4bzB4Mnkyc3J3NmNpMHY4Z3gifQ.7NFf3lfgJS3j_49hyKPLbA',
  /**
   * Replace with the url of your map style
   */
  mapStyle: 'mapbox://styles/bettyzeng/clofp6xs5005901qr0qgq55lw', 
  /**
   * The layer within the vector tileset to use for querying
   */
  sourceLayer: 'UrbAglo_AQdata-a975zf',
  /**
